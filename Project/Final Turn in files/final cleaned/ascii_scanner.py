"""
Submission sanitizer: fix Unicode in Python source.
...
def strip_text(src: str) -> str:
    # 1. Normalize line endings before tokenizing
    src = src.replace("\r\n", "\n").replace("\r", "\n")
    # 2. Token-aware Unicode sanitization (only touches COMMENT + STRING)
