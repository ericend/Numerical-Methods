...
def main():
    ...
    fig1.tight_layout()
    # fig1.savefig("plot_fod.pdf", bbox_inches="tight")
    fig1.savefig("plot_fod.png", dpi=300, bbox_inches="tight")
    ...
    ax2.semilogy(results.ns, residuals, "o-", lw=2, ms=8)
    ax2.set_xlabel(r"Iteration $k$")
    ax2.set_ylabel(r"$|f(d_k)|$")
    ax2.set_title("Convergence of Newton's Method'")
    ax2.xaxis.set_major_locator(ticker.MultipleLocator(1))
    fig2.tight_layout()
    # fig2.savefig("plot_convergence.pdf", bbox_inches="tight")
    fig2.savefig("plot_convergence.png", dpi=300, bbox_inches="tight")

    # plt.show()
    print(len(results.ns))
